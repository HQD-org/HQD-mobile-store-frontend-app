...
class PasswordVetificationScreen extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _PasswordVetificationScreen();
  }
}

class _PasswordVetificationScreen extends State<PasswordVetificationScreen> {
